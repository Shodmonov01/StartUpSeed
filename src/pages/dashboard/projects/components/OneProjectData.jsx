                ...
                <div key={item.id} className='p-2 lg:p-6 bg-white shadow-lg rounded-lg'>
                    ...
                    {!props.profileData?.active && (
                        state?.owner?.id != user_id ? (
                            ...
                            <div className='flex items-center justify-end'>
                                <button
                                    className='bg-custom-gray font-gilroy-bold lg:w-auto w-full hover:bg-gray-600 transition-all text-white py-4 px-8 text-sm rounded focus:outline-none focus:shadow-outline mt-4 cursor-not-allowed'
                                    title='Свой проект'
                                >
                                    {t("dashboard.pages.one_project_view.reply")}
                                </button>
